...
#include <X11/XF86keysym.h>  // XF86 keys arent included by default 
///---Modifiers---///
 ...
 *6)emptycol         */
static const char *colors[] = {"#f4f4f4","#373737","#06d6a0","#ef476f","#118ab2","#0d131a","#000000"};
...
static const uint8_t borders[] = {0,3,3,3};
...
static const char *searchcmd[]   = { "search_box.sh", NULL};
///--Volume Commands--///
